            ...
            <div class="col-md-6">
                <form class="animated bounce" action="bookingaction.php" method="post">
                    ...
                    <div class="input-group">
                      ...
                      <input id="department" type="text" class="form-control" name="department" placeholder="Address" required>
                    </div>
                    <br>
                    <div class="input-group">
                    ...
                    <div class="input-group">
                      ...
                      <input id="req_date" type="date" class="form-control" name="req_date" placeholder="Day the car is needed" required>
                    ...
                    <div class="input-group">
                      ...
                      <input id="return_date" type="date" class="form-control" name="return_date" placeholder="Day the car is returned" required>
                    ...
                    <div class="input-group">
                      ...
                      <input id="pickup" type="text" class="form-control" name="pickup" placeholder="Pick-up Location">
                    </div>
                    <br>
