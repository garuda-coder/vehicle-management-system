            ...
            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                ...
                <br> 
                 ...
                 <div class="input-group">
                  ...
                  <input id="vehchesis" type="text" class="form-control" name="vehchesis" placeholder="Chasis No">
                </div>
                <br> 
                
                <div class="input-group">
                  <span class="input-group-addon"><b>Manufacturer</b></span>
                  <input id="vehbrand" type="text" class="form-control" name="vehbrand" placeholder="Manufacturer">
                </div>
                <br>
